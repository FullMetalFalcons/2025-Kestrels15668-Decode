...
public class RedClose extends LinearOpMode {
    public void runOpMode() {
        Pose2d initialPose = new Pose2d(42+12,-10,Math.toRadians(-135));
        ...
        pickup2 = drive.actionBuilder(new Pose2d(9+12,-22,Math.toRadians(0)))
                .strafeTo(new Vector2d(52+12,-22))
                .build();

        launch2 = drive.actionBuilder(new Pose2d(52+12,-22,Math.toRadians(0)))
